...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center.align-items-center.my-3
      .col-12
        ul.lista-ul--color
          ...
          li 
            i.fas.fa-check
            | Contrato de dirección, manejo y confianza
    ...
    PasosA.color-acento-contenido.mb-5(tipo="n")
      ...
      div
        h3 
        p Procurar a los trabajadores locales apropiados y elementos adecuados de protección contra los accidentes y enfermedades profesionales, de manera que se garanticen razonablemente la seguridad y la salud.
    ...
    PasosA.color-secundario.mb-5(tipo="n")
      div
        h3
        p El haber sufrido engaño por parte del trabajador, mediante la presentación de certificados falsos para su admisión o tendientes a obtener un provecho indebido.

      div
        h3 
        p Todo acto de violencia, injuria, malos tratamientos o grave indisciplina en que incurra el trabajador en sus labores, contra el empleador, los miembros de su familia, el personal directivo o los compañeros de trabajo.

      div
        h3 
        p Todo acto grave de violencia, injuria o malos tratamientos en que incurra el trabajador fuera del servicio, en contra del empleador, de los miembros de su familia o de sus representantes y socios, jefes de taller, vigilantes o celadores.

      div
        h3 
        p Todo daño material causado intencionalmente a los edificios, obras, maquinarias y materias primas, instrumentos y demás objetos relacionados con el trabajo, y toda grave negligencia que ponga en peligro la seguridad de las personas o de las cosas.

      div
        h3 
        p Todo acto inmoral o delictuoso que el trabajador cometa en el taller, establecimiento o lugar de trabajo o en el desempeño de sus labores.

      div
        h3 
        p Cualquier violación grave de las obligaciones o prohibiciones especiales que incumben al trabajador de acuerdo con los Artículos 58 y 60 del CST, o cualquier falta grave calificada como tal en pactos o convenciones colectivas, fallos arbitrales, contratos individuales o reglamentos. 

      div
        h3 
        p La detención preventiva del trabajador por más de treinta (30) días, a menos que posteriormente sea absuelto; o el arresto correccional que exceda de ocho (8) días, o aún por tiempo menor, cuando la causa de la sanción sea suficiente por sí misma para justificar la extinción del contrato. 

      div
        h3 
        p El que el trabajador revele los secretos técnicos o comerciales o dé a conocer asuntos de carácter reservado, con perjuicio de la empresa.

      div
        h3 
        p El deficiente rendimiento en el trabajo en relación con la capacidad del trabajador y con el rendimiento promedio en labores análogas, cuando no se corrija en un plazo razonable a pesar del requerimiento del empleador.
      ...
      div
        h3 
        p Todo vicio del trabajador que perturbe la disciplina del establecimiento.

      div
        h3 
        p La renuencia sistemática del trabajador a aceptar las medidas preventivas, profilácticas o curativas, prescritas por el médico del empleador o por las autoridades para evitar enfermedades o accidentes.

      div
        h3 
        p La ineptitud del trabajador para realizar la labor encomendada.

      div
        h3 
        p El reconocimiento al trabajador de la pensión de la jubilación o invalidez estando al servicio de la empresa.
    ...
    figure.mb-5
      .video
        iframe(width="560" height="315" src="https://www.youtube.com/embed/Vo2C_w6H1pE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
      figcaption 
