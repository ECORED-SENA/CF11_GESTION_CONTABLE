...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    p.mb-5 Es el proceso mediante el cual se liquidan los salarios a los trabajadores, mediante una planilla o comprobante en el cual se relacionan los diferentes conceptos ganados, descuentos por seguridad social e impuestos, entre otros; generando el valor neto a pagar a cada uno de los trabajadores.  
    ...
    p.mb-3 Los beneficios a los empleados comprenden:
    ...
    img(src='@/assets/curso/images/tema2/img_9.svg', alt="", style="width:1000px;").m-auto
    ...
    .jumbotron-white 
      .row.justify-content-around.align-items-center
        .col-auto
          img(src="@/assets/curso/images/tema2/ico_29.svg" alt="", style="width:170px")
        .col       
      ...
      img(src='@/assets/curso/images/tema2/img_10.svg', alt="", style="width:1000px").m-auto.mb-5      

      .row.justify-content-center.mb-5
        .col-lg-10
          p.mb-4.text-center Con el fin de profundizar sobre la Norma Internacional (NIC) 19, se sugiere explorar las siguientes recursos: 
          .row.justify-content-center
            .col-auto
              a.anexo.mb-4(:href="obtenerLink('/downloads/NIC19_Beneficios_Empleados.pdf')" target="_blank")
                .anexo__icono
                  img(src="@/assets/template/icono-pdf.svg")
                .anexo__texto
                  p Anexo. NIC19 Norma internacional           
          
            .col-auto
              a.anexo.mb-4(:href="obtenerLink('/downloads/NIC19.pdf')" target="_blank")
                .anexo__icono
                  img(src="@/assets/template/icono-pdf.svg")
                .anexo__texto
                  p Anexo. NIC19 Beneficios a los Empleados     
      ...
      .col-9
        .bloque-texto-b.color-secundario.p-4
          .bloque-texto-b__texto.mb-1
            i.fas.fa-quote-left
            span.h4 “Trabajo suplementario o de horas extras es el que excede de la jornada ordinaria, y en todo caso el que excede de la máxima legal”
            i.fas.fa-quote-right
          .bloque-texto-d__autor 
            span  (CST, art. 159)

    h3.mb-3.titulo-tercero Horas extras y recargos nocturnos, dominicales y festivos

    p.mb-5 Son conceptos que están sujetos a la jornada laboral ordinaria del trabajador que se haya acordado entre las partes.
      ...
      .col-lg-6
        .tarjeta-avatar-b.mb-5
          ...
          .tarjeta.color-custom
            .p-4
              h3 Ejemplo 1
              p.mb-0 <b>Sueldo básico devengado:</b> si un trabajador inicia a laborar el día 2 de marzo, con un sueldo concertado con la empresa de $1.200.000, el valor devengado en el mes corresponde a $1.160.000.
      ...
      .col-lg-6
        .tarjeta-avatar-b.mb-5
          ...
          .tarjeta.color-custom
            .p-4
              h3 Ejemplo 2
              p.mb0  <b>Auxilio de transporte devengado:</b> si un trabajador inicia a laborar el día 11 de marzo, con un auxilio de transporte, según la ley $102.854, el valor devengado en el mes corresponde a $68.569 (20 días).
    ...
    .row.justify-content-center.align-items-center.mb-5 
      ...
      .col-lg-6
        img(src="@/assets/curso/images/tema2/img_11.svg" alt="", style="width:400px;").m-auto
    ...
    p.mb-5 El Artículo 383 del Estatuto Tributario, modificado por la Ley 2010 de 2019, contiene las tarifas que se deben aplicar por concepto de retención en la fuente por ingresos laborales.
    ...
    .col-12
      .tabla-a.color-acento-contenido.mb-5
        table
          caption Nota. Tomada de Dussán (2019)
          thead
            tr.th-1.text-center
    ...
    .bloque-texto-d.color-secundario.p-4.mb-5
      .bloque-texto-d__texto.mb-1
        ...
        p.mt-3.d-flex.justify-content-end (Ministerio del Trabajo. República de Colombia, 2013)
    ...
    .row.justify-content-center.align-items-center.mt-5
      .col-lg-6.mb-4.mb-lg-0
        img(src="@/assets/curso/images/tema2/img_13.svg" alt="", style="width:350px;").m-auto
    ...
    LineaTiempoD.color-secundario.my-5
      ...
      .row(numero="3" titulo="Neto a pagar")
        ...
        .col-lg-6.p-5
          p Según la liquidación de cada trabajador, se dispone al restar el total de deducciones del total devengado.
      ...
      .row.justify-content-around.align-items-center
        ...
        .col
          .row.justify-content-between.align-items-center
            .col.mb-3.mb-sm-0
              .h4.mb-1.text-white Contabilidad financiera, correlacionado con NIIF. (2ª ed.)
              p.mb-0.text-white Angulo, U. (2018). Ediciones de la U. 
